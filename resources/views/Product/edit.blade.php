          ...
          <fieldset  class="form-group  p-3" style="border:2px solid #dee2e6 ">
            ...
            <div class="row clearfix">
              <div class="col-lg-12 ">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name='designation' placeholder="Designation" value="{{ $product->designation }}">
                     </div>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <select name="category" id="orienter" class="form-control show-tick">
                        ...
                        <option value="elec" {{$product->category == 'elec' ? 'selected' : ''}}>Eléctricité</option>
                        <option value="plafond" {{$product->category == 'plafond' ? 'selected' : ''}}>Faux Plafond</option>
                    </select>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name='price_v' placeholder="Prix Vendre" value="{{ $product->price_v }}" >
                     </div>
                  </div>
              ...
              <div class="col-sm-12">
                  ...
                  <button type="" class="btn btn-outline-secondary">Cancel</button>
              </div>
